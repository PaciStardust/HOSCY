...
internal static class LegacyConfigModelLoader //todo: [TEST] Does the conversion work?
{
    ...
    internal static ConfigModel Migrate(this LegacyConfigModel oldConfig, ILogger logger)
    {
        ...
        return new ConfigModel()
        {
            ...
            Recognition_Whisper_CurrentModel = oldConfig.Speech.WhisperModelCurrent,
            Recognition_Whisper_UseSingleSegmentMode = oldConfig.Speech.WhisperSingleSegment,
            Recognition_Whisper_TranslateToEnglish = oldConfig.Speech.WhisperToEnglish,
            Recognition_Whisper_RemoveRandomBrackets = oldConfig.Speech.WhisperBracketFix,
            Recognition_Whisper_IncreaseThreadPriority = oldConfig.Speech.WhisperHighPerformance,
            ...
            Recognition_Whisper_DetectPauseDurationSeconds = oldConfig.Speech.WhisperRecPauseDuration,
            Recognition_Whisper_GraphicsAdapter = oldConfig.Speech.WhisperGraphicsAdapter,
