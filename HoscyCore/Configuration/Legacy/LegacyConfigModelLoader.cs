...
public static class LegacyConfigModelLoader
{
    ...
    public static ConfigModel Migrate(this LegacyConfigModel oldConfig, ILogger logger)
    {
        ...
        return new ConfigModel()
        {
            ...
            Output_VrcTxt_Send_MaxDisplayedCharacters = oldConfig.Textbox.MaxLength,
            Output_VrcTxt_Do_Send = oldConfig.Speech.UseTextbox || oldConfig.Input.UseTextbox,
            Output_VrcTxt_Do_Indicator = oldConfig.Textbox.UseIndicatorWithoutBox || oldConfig.Textbox.UseIndicatorWhenSpeaking,

            Output_VrcTxt_Timeout_DynamicPer20CharactersDisplayedMs = oldConfig.Textbox.TimeoutMultiplier,
            Output_VrcTxt_Timeout_DynamicMinimumMs = oldConfig.Textbox.MinimumTimeout,
            Output_VrcTxt_Timeout_StaticMs = oldConfig.Textbox.DefaultTimeout,
            Output_VrcTxt_Timeout_UseDynamic = oldConfig.Textbox.DynamicTimeout,
            Output_VrcTxt_Timeout_AutomaticallyClearNotification = oldConfig.Textbox.AutomaticClearNotification,
            Output_VrcTxt_Timeout_AutomaticallyClearMessage = oldConfig.Textbox.AutomaticClearMessage,

            Output_VrcTxt_Notification_IndicatorTextStart = oldConfig.Textbox.NotificationIndicatorLeft,
            Output_VrcTxt_Notification_IndicatorTextEnd = oldConfig.Textbox.NotificationIndicatorRight,
            Output_VrcTxt_Notification_UsePrioritySystem = oldConfig.Textbox.UseNotificationPriority,
            Output_VrcTxt_Notification_SkipWhenMessageAvailable = oldConfig.Textbox.UseNotificationSkip,

            Output_VrcTxt_Sound_OnMessage = oldConfig.Textbox.SoundOnMessage,
            Output_VrcTxt_Sound_OnNotification = oldConfig.Textbox.SoundOnNotification,
