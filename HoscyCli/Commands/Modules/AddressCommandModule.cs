...
public class AddressCommandModule(ReflectPropEditCommandModule _reflectCm) : AttributeCommandModule, ICoreCommandModule
{
    ...
    private QuickConfigCommandInfo[] GetQuickCommands()
    {
        return [
            ...
            new(["listening-status"],nameof(ConfigModel.Osc_Address_Tool_NotificationForRecognitionListening), ConfigModel.DESC_Osc_Address_Tool_NotificationForRecognitionListening)
        ];
    }
}